...
### 👨‍💻 Daniel Sierra  
**Telecommunications and Electronics Engineer | IoT and Radiocommunications Specialist | Frontend Developer**  

My career bridges global connectivity with the creation of digital experiences. As a telecommunications engineer and frontend developer, I specialize in designing solutions that efficiently and seamlessly connect people, devices, and data.  

🔧 **Areas of Expertise**:  
- Design and implementation of IoT systems (technologies such as MQTT, Node-RED, LoRaWAN, RFID, BLE, and wireless protocols).  
- Radiocommunications and network analysis.  
- Development of dynamic and responsive interfaces with a strong focus on user experience.  

## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/https://www.instagram.com/danielsp_07/?next=%2F) 
...
# 📊 GitHub Stats:
![](https://github-readme-streak-stats.herokuapp.com/?user=soydanielsierradev&theme=dark&hide_border=true)<br/>

---
[![](https://visitcount.itsvg.in/api?id=soydanielsierradev&icon=0&color=0)](https://visitcount.itsvg.in)
